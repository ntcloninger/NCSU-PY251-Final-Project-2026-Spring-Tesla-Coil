...
def Tesla_Coil_Solver(t, pars): #take in initial value and parameters
    ...
    class Tesla_Coil:
        def __init__(self, pars): #set paramters, Mi, and breakdown voltage
            self.L1 = pars[0]
            self.L2 = pars[1]
            self.L3 = pars[2]
            self.L4 = pars[3]
        ...
        def f(self,t): #driving functions
            return self.AC_amplitude*np.sin(self.AC_frequency*t)
        
        def df(self,t): #derivative driving function
            return self.AC_frequency*self.AC_amplitude*np.cos(self.AC_frequency*t)

        def deriv1(self, q,t):#organizes derivative equations with given initial before breakdown
        ...
        def deriv2(self, q,t):#organizes derivative equations with given initial after breakdown
    ...
    return q1,q2 #returns before and after breakdown